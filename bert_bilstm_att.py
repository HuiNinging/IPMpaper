...
class bert_lstm(nn.Module):
    ...
    def forward(self, x, hidden):
        ...
        attn_output, attention = self.attention_net(lstm_out, hidden_last_out)
...
class ModelConfig:
    ...
    save_path = 'bert_bilstm_att.pth' #模型保存路径
...
if __name__ == '__main__':
    ...
    data=pd.read_csv('data/data_add.csv',encoding='gb18030')
    ...
    y = torch.from_numpy(data['topic'].values).float()
    ...
    # train_model(model_config, train_loader)   # 训练模型，如果已训练就注释掉这行
